        ...
        Using _connection = GetConnection()
            ...
            Using _command = New MySqlCommand
                Try
                    ...
                    End If
                Catch ex As MySqlException
                    Throw New SystemException("ERROR(DBPaciente,BorrarPaciente)" & ex.Message)
                End Try
            End Using
        End Using
        ...
        Using _connection = GetConnection()
            ...
            Using _command = New MySqlCommand
                Try
                    ...
                    End If
                Catch ex As MySqlException
                    Throw New SystemException("ERROR(DBPaciente,ModifPaciente)" & ex.Message)
                End Try
            End Using
        End Using
        ...
        Using _connection = GetConnection()
            ...
            Using _command = New MySqlCommand
                Try
                    ...
                    Return True
                Catch ex As MySqlException
                    Throw New SystemException("ERROR(DBPaciente, solicitarChat)" & ex.Message)
                End Try
        ...
        Using _connection = GetConnection()
            ...
            Using _command = New MySqlCommand
                Try
                    ...
                    End While
                Catch ex As MySqlException
                    Throw New SystemException("ERROR(DBPaciente, PreguntarSolicitud)" & ex.Message)
                End Try
            End Using
        End Using
    End Function
        ...
        Using _connection = GetConnection()
            ...
            Using _command = New MySqlCommand
                Try
                    ...
                    Return True
                Catch ex As MySqlException
                    Throw New SystemException("ERROR(DBPaciente,EliminarSolicitud)" & ex.Message)
                End Try
            End Using
        End Using
    End Function
        ...
        Using _connection = GetConnection()
            ...
            Using _command = New MySqlCommand
                Try
                    ...
                    End If
                Catch ex As MySqlException
                    Throw New SystemException("ERROR(DBPaciente,comprobarMSj)" & ex.Message)
                End Try
            End Using
        End Using
        Return msj
        ...
        Using _connection = GetConnection()
            ...
            Using _command As New MySqlCommand
                Try
                    ...
                    Return True
                Catch ex As MySqlException
                    Throw New SystemException("ERROR(DBPaciente,SetFicha)" & ex.Message)
                End Try
            End Using
        End Using
    End Function
