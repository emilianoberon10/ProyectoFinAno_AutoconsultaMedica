...
Public Class DBEnvioCorreo
    ...
    End Sub
    Public Shared Function EnviarCorreoRecuperarPass(usuario, contra, email_destino) As Boolean
        ...
        Dim mensaje As String = "<html>
                                ...
                                <body>
                                    <h2> RECUPERAR CONTRASEÑA, SAM </h2>
                                    <hr>
                                    <p>
                                        Usted a pedido recuperar su contraseña del Sistema de Autoconsulta Medica <br> 
                                        Si no ah sido usted, contacte con la medica
                                        <br>
                                        <span class='datos'>
                                            Usuario: " & usuario & "
                                            <br>
                                        ...
                                        <br>
                                        <span class='aclaracion'> ==> Por favor al ingresar cambie su contraseña en el menu de opciones <== </span>
                                    </p>
                                </body>
                                </html>"
        ' Servidor de correo
